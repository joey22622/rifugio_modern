...
<?php if ( class_exists('acf') ) : ?>
    ...
    <div class="container">
      ...
      <div class="row">
			...
			<?php if ( $variants == 'one' || $variants == 'two') : ?> 

      		<div class="col-md-5 single-project">

      		<?php endif; ?>

      		<?php if ( $variants == 'three' || $variants == 'four') : ?> 
      		...
      		<h4 class="title-project"><?php echo get_the_title(); ?></h4>
			...
			?>	
				...
				<h5><?php echo esc_html($author_title); ?></h5>
					<p><?php echo esc_html($author); ?></p>

				<h5><?php echo esc_html($client_title); ?></h5>
					<p><?php echo esc_html($client_name); ?></p>

				<h5><?php echo esc_html($project_date_title); ?></h5>
					<p><?php echo esc_html($project_date); ?></p>

				<h5><?php echo esc_html($project_location_title); ?></h5>
					<p><?php echo esc_html($project_location); ?></p>

				<?php if ( $social_icons_portfolio == 'show' ) : ?> 
