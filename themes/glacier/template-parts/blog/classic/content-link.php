...
if ( class_exists('acf') ) :
    ...
    // vars ( ACF )
    $link_format_post_options = get_field('link_format_post_options');
     ...
     <div class="<?php echo esc_html($blog_animation); ?>">
    	...
    	<div class="entry-header">
      	  ...
      	  <?php if ($thumbnail_src) : ?>
        		...
        		<div class="post-intro type-link" style="background-image: url('<?php echo esc_url($thumbnail_src[0]); ?>');">
      	  		<a href="<?php echo esc_url($link_format_post_options); ?>">
      	  		  <?php echo esc_html($link_format_post_options); ?>
      	  		</a>
        		</div>

          <?php else : ?>

            <div class="post-intro type-link img-none">
            <a href="<?php echo esc_url($link_format_post_options); ?>">
              <?php echo esc_html($link_format_post_options); ?>
            </a>
            </div>
