...
class glacier_VlthemesAddTypekit {
    private $_typekit_id;
    public $typekit_enable;
    public $typekit_fonts;
    public function __construct() {
        $this->_typekit_id = get_theme_mod('typekit_id');
        $this->typekit_enable = get_theme_mod('enable_typekit');
        $this->typekit_fonts = get_theme_mod('typekit_fonts');
...
new glacier_VlthemesAddTypekit;
